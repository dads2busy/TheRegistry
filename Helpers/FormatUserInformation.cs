...
namespace Questionnaire2.Helpers
{
    public class FormatUserInformation
    {
        ...
        protected List<Paragraph> PersonalInformation(List<Respons> pi)
        {
            var sections = new List<Paragraph>();

            if (!pi.Any()) return sections;

            var notfound = new List<Respons> {new Respons() {ResponseItem = "Not Found"}};

            var response1 = pi.Any(x => x.QuestionText == "First Name") ? pi.Where(x => x.QuestionText == "First Name") : notfound;
            var enumerable1 = response1 as IList<Respons> ?? response1.ToList();
            ...
            var enumerable2 = response2 as IList<Respons> ?? response2.ToList();
            ...
            var enumerable3 = response3 as IList<Respons> ?? response3.ToList();
            ...
            var enumerable4 = response4 as IList<Respons> ?? response4.ToList();
            ...
            var enumerable5 = response5 as IList<Respons> ?? response5.ToList();
            var item5 = enumerable5.Single().ResponseItem ?? "test string";
            sections.Add(new Paragraph() { Text = item5, Format = _subtitle, Align = Center });
            return sections;
        }

        protected List<Paragraph> EmploymentInformation(List<Respons> pi)
        {
            var sections = new List<Paragraph>();
            ...
            for (var i = 0; i < subordinalMax + 1; i++)
            {
                ...
                var enumerable3 = response2 as IList<Respons> ?? response2.ToList();
                ...
                var enumerable4 = response2 as IList<Respons> ?? response2.ToList();
                ...
                var enumerable5 = response2 as IList<Respons> ?? response2.ToList();
                ...
                var enumerable6 = response3Test1 as IList<Respons> ?? response3Test1.ToList();
                ...
                {
                    var enumerable7 = response3Test2 as IList<Respons> ?? response3Test2.ToList();
                    ...
                    {
                        var enumerable8 = response3Test3 as IList<Respons> ?? response3Test3.ToList();
                ...
                var enumerable9 = response3 as IList<Respons> ?? response3.ToList();
                ...
                var enumerable10 = response4 as IList<Respons> ?? response4.ToList();
        ...
        protected List<Paragraph> CertificationInformation(List<Respons> pi)
        {
            var sections = new List<Paragraph>();
        ...
        protected List<Paragraph> LicenseInformation(List<Respons> pi)
        {
            var sections = new List<Paragraph>();
        ...
        protected List<Paragraph> EducationInformation(List<Respons> pi)
        {
            var sections = new List<Paragraph>();
        ...
        protected List<Paragraph> CredentialEndorsementInformation(List<Respons> pi)
        {
            var sections = new List<Paragraph>();
            ...
            for (var i = 0; i < subordinalMax + 1; i++)
            {
                ...
                var enumerable6 = response6 as IList<Respons> ?? response6.ToList();
        ...
        protected List<Paragraph> OtherCourseworkInformation(List<Respons> pi)
        {
            var sections = new List<Paragraph>();
            ...
            for (var i = 0; i < subordinalMax + 1; i++)
            {
                ...
                var enumerable7 = response7 as IList<Respons> ?? response7.ToList();
        ...
        protected List<Paragraph> ProfessionalTrainingInformation(List<Respons> pi)
        {
            var sections = new List<Paragraph>();
            ...
            for (var i = 0; i < subordinalMax + 1; i++)
            {
                ...
                var enumerable8 = response8 as IList<Respons> ?? response8.ToList();
                ...
                var enumerable10 = response10 as IList<Respons> ?? response10.ToList();
